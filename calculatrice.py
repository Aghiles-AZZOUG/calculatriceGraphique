...
# Graphing Calculator
# 8 November 2019
# Graphs functions based on user-input but the binary is in exterior of this code (sorry mr Sonntag ;) )
...
root.wm_title("Ma SuperCalculatrice-veuillez suivre l'exemple")
